...
The activation script configures Homebrew ffmpeg@7 for TorchCodec.
SGLANG_USE_MLX=1 selects the MLX runner; omit it for Torch/MPS.
CosyVoice checkout: $COSYVOICE_DIR
The activation script also configures its PYTHONPATH.
EOF
