...
| Model | Description |
| --- | --- |
| [`Qwen/Qwen3-Omni-30B-A3B-Instruct`](https://huggingface.co/Qwen/Qwen3-Omni-30B-A3B-Instruct) | End-to-end multilingual omni-modal model. Processes text, images, audio, and video, and delivers streaming responses in both text and natural speech. |
| [`fishaudio/s2-pro`](https://huggingface.co/fishaudio/s2-pro) | Text-to-speech model with fine-grained control of prosody and emotion. |
