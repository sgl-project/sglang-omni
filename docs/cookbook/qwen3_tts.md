...
dependencies so the SGLang-Omni Transformers 5.12 / SGLang 0.5.17 stack remains
in place:
...
applies before importing `qwen_tts`. The pinned Transformers 5.12 / SGLang 0.5.17
