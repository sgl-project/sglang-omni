...
- **Broad Model Support**: Supports a growing set of TTS, ASR, and omni models including Higgs Audio, Fish Audio S2-Pro, Voxtral TTS, Qwen3 TTS, MOSS-TTS, CosyVoice3, Qwen3-ASR, Whisper ASR, Qwen3-Omni, Ming-Omni, and LLaDA2.0-Uni.
...
.. list-table::
   ...
   * - `FunAudioLLM/Fun-CosyVoice3-0.5B-2512 <https://huggingface.co/FunAudioLLM/Fun-CosyVoice3-0.5B-2512>`_
     - TTS
     - Zero-shot voice cloning, 24 kHz, Chinese / multilingual
