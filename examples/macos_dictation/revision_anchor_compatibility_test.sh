#!/bin/bash
# Simulated editor and isolated pasteboard; no real application input events.
set -euo pipefail
...
xcrun swiftc -whole-module-optimization -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
    ...
    "$project_dir/Tests/RevisionAnchorCompatibility_test.swift" -o "$test_dir/RevisionAnchorCompatibility_test"
/usr/bin/codesign --force --sign - "$test_dir/RevisionAnchorCompatibility_test"
"$test_dir/RevisionAnchorCompatibility_test"
