...
xcrun swiftc -whole-module-optimization -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
    ...
    "$project_dir/Tests/RevisionConfirmation_test.swift" -o "$test_dir/RevisionConfirmation_test"
/usr/bin/codesign --force --sign - "$test_dir/RevisionConfirmation_test"
"$test_dir/RevisionConfirmation_test"
