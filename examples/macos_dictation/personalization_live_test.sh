...
test_dir="$project_dir/.build/personalization-live-tests"
...
xcrun swiftc -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
  ...
  "$project_dir/Tests/PersonalizationLive_test.swift" -o "$test_dir/PersonalizationLive_test"
"$test_dir/PersonalizationLive_test" "$@"
