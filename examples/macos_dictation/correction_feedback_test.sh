...
xcrun swiftc -whole-module-optimization -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
    ...
    "$project_dir"/Sources/DictationCore/*.swift "$project_dir/Tests/CorrectionFeedback_test.swift" \
    -o "$test_dir/CorrectionFeedback_test"
/usr/bin/codesign --force --sign - "$test_dir/CorrectionFeedback_test"
"$test_dir/CorrectionFeedback_test"
