...
test_dir="$project_dir/.build/polish-fidelity-tests"
...
xcrun swiftc -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
  ...
  "$project_dir/Tests/PolishFidelity_test.swift" -o "$test_dir/PolishFidelity_test"
"$test_dir/PolishFidelity_test"
