...
test_dir="$project_dir/.build/personalization-tests"
...
xcrun swiftc -swift-version 5 -parse-as-library -target arm64-apple-macosx14.0 \
  ...
  "$project_dir/Tests/Personalization_test.swift" -o "$test_dir/Personalization_test"
"$test_dir/Personalization_test"
