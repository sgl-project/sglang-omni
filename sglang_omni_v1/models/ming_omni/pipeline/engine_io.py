...
from sglang_omni_v1.engines.omni.runtime import ARRequestData, EncoderRequestData
from sglang_omni_v1.models.ming_omni.io import PipelineState, ThinkerOutput

if TYPE_CHECKING:
    from sglang_omni_v1.engines.omni.runtime.sglang_ar import SGLangARRequestData
