...
from sglang_omni_v1.executors.interface import Executor
...
class MingTalkerExecutor(Executor):
    ...
    def _load_models(self) -> None:
        ...
        from sglang_omni_v1.models.ming_omni.talker import (
            MingOmniTalker,
            MingOmniTalkerConfig,
            SpkembExtractor,
        )
        from sglang_omni_v1.models.ming_omni.talker.audio_vae.modeling_audio_vae import (
            AudioVAE,
        )
