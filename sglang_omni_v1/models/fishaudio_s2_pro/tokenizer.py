...
from sglang_omni_v1.models.fishaudio_s2_pro.fish_speech.tokenizer import (
    IM_END_TOKEN,
...
class S2ProTokenizerAdapter:
    ...
    def build_prompt(
        ...
        **kwargs: Any,
        ...
        from sglang_omni_v1.models.fishaudio_s2_pro.fish_speech.content_sequence import (
            TextPart,
            VQPart,
        )
        from sglang_omni_v1.models.fishaudio_s2_pro.fish_speech.conversation import (
            Conversation,
            Message,
        )
