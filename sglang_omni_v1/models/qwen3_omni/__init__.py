...
if TYPE_CHECKING:
    from sglang_omni_v1.models.qwen3_omni import config
    from sglang_omni_v1.models.qwen3_omni.components.audio_encoder import (
        Qwen3OmniAudioEncoder,
    )
    from sglang_omni_v1.models.qwen3_omni.components.common import Qwen3OmniSpec
    ...
    from sglang_omni_v1.models.qwen3_omni.components.thinker import (
