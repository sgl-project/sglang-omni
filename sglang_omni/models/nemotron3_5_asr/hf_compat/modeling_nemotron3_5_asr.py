...
from .generation_nemotron3_5_asr import (
    Nemotron3_5AsrGenerationMixin,
    Nemotron3_5AsrRNNTDecoderCache,
)
from .modeling_nemotron_asr_streaming import NemotronAsrStreamingEncoder
...
class Nemotron3_5AsrRNNTOutput(BaseModelOutputWithPooling):
    ...
    padding_cache: "NemotronAsrStreamingEncoderCausalConvPaddingCache | None" = (
        None  # noqa: F821
    )
...
class Nemotron3_5AsrPromptProjector(nn.Module):
    def __init__(self, config: Nemotron3_5AsrConfig):
        ...
        self.linear_2 = nn.Linear(
            config.prompt_intermediate_size, config.encoder_config.hidden_size
        )
...
class Nemotron3_5AsrForRNNT(
    Nemotron3_5AsrPreTrainedModel, Nemotron3_5AsrGenerationMixin
):
    config: Nemotron3_5AsrConfig
