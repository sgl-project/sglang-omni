...
from sglang_omni.models.cosyvoice3.cosyvoice.utils.file_utils import load_wav, logging
from sglang_omni.models.cosyvoice3.cosyvoice.utils.frontend_utils import (
    contains_chinese,
    is_only_punctuation,
    remove_bracket,
    replace_blank,
...
class CosyVoiceFrontEnd:
    ...
    def __init__(
        ...
        # LOCAL MODIFICATION (sglang-omni): honor an explicit ``device`` from stage
        # placement instead of always grabbing the default CUDA device; upstream
        # unconditionally used cuda:0 whenever CUDA was visible.
        ...
        # LOCAL MODIFICATION (sglang-omni): pin the ORT CUDA provider to the placed
        # device (upstream let it default to device 0).
