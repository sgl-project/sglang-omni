...
#
# LOCAL MODIFICATION (sglang-omni): removed the unused Whisper-derived multilingual
# tiktoken tokenizer path -- the LANGUAGES tables, get_encoding()/get_tokenizer(), and the
# 58k-line assets/*.tiktoken vocabulary. CosyVoice3 tokenizes text with the Qwen
# AutoTokenizer loaded from the model checkpoint (CosyVoice3Tokenizer below); the tiktoken
# path was never reached from the sglang-omni frontend.
