    ...
    def require_headroom(
        ...
        *,
        ...
        raise CaptureFailure(
            ...
            f"{format_bytes_gib(self.min_free_bytes)} headroom{key_text}"
        )
    ...
    def decode_slots(
        ...
        if os.getpid() != self.owner_pid:
            raise RuntimeError(
                ...
                f"{self.owner_pid}, but was used in PID {os.getpid()}"
            )
