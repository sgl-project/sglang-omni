...
class EngineExecutor(Executor):
    ...
    def __init__(
        ...
        self._stream_queue: Any | None = None  # Set by compiler for stream-receiving stages
        self._stream_fn: Callable | None = None  # Set by compiler for stream-sending stages
