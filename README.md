...
| [Qwen/Qwen3-ASR-1.7B](https://huggingface.co/Qwen/Qwen3-ASR-1.7B) | ASR | Audio transcription through `/v1/audio/transcriptions` |
| [openai/whisper-large-v3](https://huggingface.co/openai/whisper-large-v3) | ASR | Experimental — transcription endpoint available but output not yet validated; prefer Qwen3-ASR |
