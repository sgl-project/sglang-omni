...
| **Apple Silicon** | Experimental | Apple M-series GPUs via native MLX or Torch MPS on macOS arm64. **Qwen3-ASR and Whisper serve end-to-end** from the official checkpoints. Install with [`install.sh`](./install.sh); see the [Qwen3-ASR](./docs/cookbook/qwen3_asr.md#apple-silicon-mlx) and [Whisper](./docs/cookbook/whisper_asr.md#apple-silicon-mlx) guides. |
