...
- **API surface**: OpenAI-compatible endpoints expose multimodal chat, speech generation, batch speech, streaming speech, uploaded voices, transcription, and Whisper translation.
...
- **Audio transcription, translation, and diarization**: Serve [Qwen3-ASR](https://sgl-project.github.io/sglang-omni/cookbook/qwen3_asr.html), [Fun-ASR-Nano](https://sgl-project.github.io/sglang-omni/cookbook/fun_asr.html), [Whisper](https://sgl-project.github.io/sglang-omni/cookbook/whisper_asr.html), and [MOSS-Transcribe-Diarize](https://sgl-project.github.io/sglang-omni/cookbook/moss_transcribe_diarize.html) through `/v1/audio/transcriptions`; Whisper also supports speech-to-English `/v1/audio/translations`. MOSS-TD supports speaker-labelled, timestamped transcript segments with `response_format=verbose_json`.
