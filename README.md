...
- **Visual generation**: [Cosmos 3 Super](https://sgl-project.github.io/sglang-omni/cookbook/cosmos3.html) — initial BF16 text-to-image support through the Omni SDK and `/v1/images/generations`.
