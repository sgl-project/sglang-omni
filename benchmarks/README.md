...
throughput are engineering diagnostics, not SocialOmni paper metrics. Before
timing either level, the benchmark sends one warmup request per configured
concurrent worker by repeating the first sample.
